...
public class Streams
{
    public static void main(String[] args)
    {
        ...
        System.out.println("BufferedReader wraps a Reader object and uses buffering to read efficiently it.");
        ...
        System.out.println("BufferedWriter wraps a Writer object and uses buffering to write efficiently trough it.");
        ...
        System.out.println("BufferedOutputStream wraps an OutputStream and uses buffering to write efficiently to it.");
        System.out.println("PrintStream wraps an OutputStream or a File and adds support for auto flush and ability to print representations of various data values conveniently. System.out is a PrintStream.");
